...
class QuoteController extends Controller
{
    ...
    public function index()
    {
        ...
        return response()->json([
            ...
            'quotes' => [
                ...
                "Mae is one of my favorite rappers and I based a lot of my flows off of him",
                "Manga all day",
    ...
    {
        $checkFavourite =Favourites::Where('favourite_quotes', 'like', '%' . $request->get('favourite_quotes') . '%')->get()->toArray();
        if(!empty($checkFavourite)){
            ...
            $input = $request->all();
            $Favourites = Favourites::create($input);
